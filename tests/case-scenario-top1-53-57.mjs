...
runCaseSpec(loadScenarios(53, "follow")[0], 53);
runStructureCase(54);
runCaseSpec(loadScenarios(55, "follow")[0], 55);
runCaseSpec(loadScenarios(56, "follow")[0], 56);
runCaseSpec(loadScenarios(57, "open")[0], 57);
console.log("PASS 例53～57 场景 Top1 golden");
