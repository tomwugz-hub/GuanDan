...
runCaseSpec(loadScenarios(58, "follow")[0], 58);
runStructureCase(59);
runCaseSpec(loadScenarios(60, "follow")[0], 60);
runCaseSpec(loadScenarios(61, "open")[0], 61);
runStructureCase(62);
console.log("PASS 例58～62 场景 Top1 golden");
