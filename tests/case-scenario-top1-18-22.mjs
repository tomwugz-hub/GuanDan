...
runCase(18, PLAY_TYPES.single, "4");
runCase(19, PLAY_TYPES.single, "2");
runCase(20, PLAY_TYPES.single, "6");
runCase(21, PLAY_TYPES.tripleWithPair, "2");
runCase(22, PLAY_TYPES.straight, "5");
