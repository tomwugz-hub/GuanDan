...
runCaseSpec(loadScenarios(73, "follow")[0], 73);
runStructureCase(74);
runCaseSpec(loadScenarios(75, "open")[0], 75);
runCaseSpec(loadScenarios(76, "follow")[0], 76);
runCaseSpec(loadScenarios(77, "open")[0], 77);
console.log("PASS 例73～77 场景 Top1 golden");
