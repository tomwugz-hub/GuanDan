...
runCaseSpec(loadScenarios(68, "follow")[0], 68);
runStructureCase(69);
runStructureCase(70);
runCaseSpec(loadScenarios(71, "follow")[0], 71);
runCaseSpec(loadScenarios(72, "follow")[0], 72);
console.log("PASS 例68～72 场景 Top1 golden");
