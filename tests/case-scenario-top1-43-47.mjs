...
runStructureCase(43);
runCase(44, PLAY_TYPES.single, "J");
runCase(45, PLAY_TYPES.straight, "Q");
runCase(46, PLAY_TYPES.consecutivePairs, "A");
runStructureCase(47);
console.log("PASS 例43～47 场景 Top1 golden");
