/**
 * 例88～92 场景 Top1 golden：批次17（例88/85 书中缺失，跳过）
 */
...
runCaseSpec(loadScenarios(89, "open")[0], 89);
runCaseSpec(loadScenarios(90, "follow")[0], 90);
runCaseSpec(loadScenarios(91, "open")[0], 91);
runCaseSpec(loadScenarios(92, "follow")[0], 92);
console.log("PASS 例88～92 场景 Top1 golden（例88 跳过）");
