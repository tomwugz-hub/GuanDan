...
function runStructureCase(n) {
  ...
  assert(
    ...
    `例${n} structure 期望 SF/J 优于 TWP/8，得 prefer=${preferScore} over=${overScore}`,
  );
  console.log(`PASS 例${n} structure: ${spec.prefer.type}/${spec.prefer.mainRank} 优于 ${spec.over.type}/${spec.over.mainRank}`);
}

runStructureCase(33);
runCase(34, PLAY_TYPES.single, "J");
runCase(35, PLAY_TYPES.tripleWithPair, "5");
runCase(36, PLAY_TYPES.straight, "10");
runCase(37, PLAY_TYPES.consecutivePairs, "6");
console.log("PASS 例33～37 场景 Top1 golden");
