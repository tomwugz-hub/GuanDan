/**
 * 例83～87 场景 Top1 golden：批次16（例85 书中缺失，跳过）
 */
...
runStructureCase(83);
runCaseSpec(loadScenarios(84, "follow")[0], 84);
runCaseSpec(loadScenarios(86, "follow")[0], 86);
runCaseSpec(loadScenarios(87, "open")[0], 87);
console.log("PASS 例83～87 场景 Top1 golden（例85 跳过）");
