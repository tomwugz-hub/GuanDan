...
const cases = [
  ...
  "game4-turn5-partner-bomb-pass.mjs",
  "game4-turn13-catch-wind-single-not-sf.mjs",
  "game4-turn41-must-beat-pair-pass-sf.mjs",
  "must-beat-twp-no-break-sf-game-path.mjs",
  "must-beat-single-legal-top1.mjs",
  "beat-bomb-prefer-full-five-bomb.mjs",
  "match7-routine-twp-heavy-hand-pass.mjs",
  "beat-level-twp-bomb-only-pass.mjs",
  "robot-routine-bomb-heavy-hand-pass.mjs",
  "robot-lead-steel-plate-not-split-triple.mjs",
  "robot-lead-no-split-four-bomb-pair.mjs",
  "robot-catch-wind-no-split-twp.mjs",
